...
import { Shield, Factory, Package, Globe, CheckCircle2 } from 'lucide-react';
      ...
      <section className="pt-28 pb-16 bg-gradient-to-b from-muted/50 to-background">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <Link 
              to="#advantages" 
              className="bg-rashmi-red hover:bg-rashmi-red/90 text-white px-8 py-3 rounded-md inline-block transition-colors"
            >
              Explore Advantages
            </Link>
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
            ...
            >
              ...
              <p className="text-muted-foreground">
                We produce Ductile Iron Pressure Pipes as per ISO 8329:2000 which helps us maintain excellent standards of production.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground">
                With our hard work and utmost dedication, we have upgraded our production to 7,70,000 Metric Tonnes of DI Pipes annually.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground">
                The DI Pipes made by Rashmi Metaliks conform to ISO1829 as well as International Standards ISO:2531, BSEN545, BSEN598, and more.
              </p>
            </motion.div>
          </div>
          ...
          <div className="mb-16" id="advantages">
            ...
            >
              ...
              <p className="text-muted-foreground">
                What veins and arteries are to humans is what DI Pipes are to the modern civilizations. 
            ...
            >
              {[
                ...
                <motion.div 
                  key={index}
                  className="bg-muted/30 rounded-lg p-4 flex items-start space-x-3"
                  variants={fadeIn}
                >
                  <CheckCircle2 className="text-rashmi-red shrink-0 mt-0.5" size={20} />
                  <span>{advantage}</span>
                </motion.div>
              ))}
            </motion.div>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsContent value="why-rashmi" className="mt-4">
                <div className="prose prose-lg max-w-none dark:prose-invert">
                  ...
                  <p>
                    What veins and arteries are to humans is what DI Pipes are to the modern civilizations. As cities, towns and villages grow, 
                    transporting water for human consumptions from its source is a growing challenge.
                  </p>
                  <p>
                    It is here that the range of high tensile strength, corrosion resistant and durable DI Pipes from the Rashmi Metaliks find their usefulness.
                  </p>
              ...
              <TabsContent value="manufacturing" className="mt-4">
                <div className="prose prose-lg max-w-none dark:prose-invert">
                  ...
                  <p>
                    The DI Pipe from the Rashmi Metaliks stable is made in a state of the art and integrated plant located at Kharagpur, West Bengal. 
                  ...
                  <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6 list-none pl-0">
                    <li className="flex items-center bg-muted/30 p-4 rounded-lg">
                  ...
                  <div className="mt-8">
                    <p>
                      ...
                      leading to superior quality and consistent performance of our DI Pipes.
                    </p>
                  </div>
                </div>
              </TabsContent>
              ...
              <TabsContent value="product-range" className="mt-4">
                <div className="prose prose-lg max-w-none dark:prose-invert">
                  ...
                  <p>
                    The A+ grade quality of DI Pipe is manufactured in a wide range of application – from DN 100 to DN 1200. 
              ...
              <TabsContent value="global-vision" className="mt-4">
                <div className="prose prose-lg max-w-none dark:prose-invert">
                  ...
                  <p>
                    The DI Pipes made by Rashmi Metaliks conform to ISO1829 as well as International Standards ISO:2531, 
      ...
      <section className="py-20 bg-gradient-to-b from-background to-muted/30">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto mb-8">
            Contact our experts today to discuss your requirements and discover how Rashmi DI Pipes can provide 
            the perfect solution for your water infrastructure needs.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <button className="bg-rashmi-red hover:bg-rashmi-red/90 text-white px-8 py-3 rounded-md transition-colors">
              Request a Quote
            </button>
